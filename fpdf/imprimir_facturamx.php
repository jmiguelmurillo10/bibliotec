...
/*  
	...
	Fecha Liberación del código: 20/04/2010
	CodeKa Mx 2010			 
...
$lafila=mysql_fetch_array($resultado);
	...
	$fecha = implota($lafila["fecha"]);
	$pdf->Cell(25);
	$pdf->Cell(5,4,$dia1,0,0,'L',0);
	$pdf->Cell(5,4,$mes1,0,0,'L',0);
	$pdf->Cell(8,4,$ano1,0,0,'L',0);
	$pdf->Ln(5);
	$pdf->Cell(20);
...
//	$pdf->Cell(15,4,$ano1,0,0,'L',0);
	...
	//modifica posicion totales
	$pdf->SetY(200);	
	$pdf->Cell(98);
    $pdf->Cell(33,4,$importe4,0,0,'R',0);
	$pdf->Ln(5);
	$pdf->Cell(98);
	$pdf->Cell(20,4,$lafila["iva"] ." %",0,0,'R',0);
	$pdf->Cell(13,4,$impo,0,0,'R',0);	
	$pdf->Ln(5);
	$pdf->Cell(98);
	$pdf->Cell(33,4,$total2,0,0,'R',0);
	$pdf->Ln(5);
	...
	$pdf->Cell(40,4,strtoupper($nw->toWords($decimales[0], "es") ." dolares ".$decimales[1]."/100"),0,0,'L',0);
      @mysql_free_result($resultado); 
      @mysql_free_result($query);
	  @mysql_free_result($resultado2); 
	  @mysql_free_result($query3);
      $pdf->Output($name=("Factura pequeña.pdf"),'I');
?>