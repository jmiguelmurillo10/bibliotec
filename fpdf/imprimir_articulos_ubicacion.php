...
$pdf->SetY(20);
$pdf->SetX(0);
$pdf->MultiCell(290,6,"Listado de Articulos por Ubicacion",0,C,0);
...
$consulta="select codubicacion,nombre from ubicaciones where borrado=0 order by nombre asc";
$query = mysql_query($consulta);
$item=1;   
while ($row = mysql_fetch_array($query))
        {
		$sel_articulos="select * from articulos where borrado=0 and codubicacion=".$row["codubicacion"]."";
