	...
	<body onLoad="inicio()">
				...
				<form id="formulario" name="formulario" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
					  <tr>
					    ...
					    <td width="69%"><input id="fechainicio" type="text" class="cajaPequena" NAME="fechainicio" maxlength="10" value="<? echo $fechainicio?>"><img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" title="Calendario">
        <script type="text/javascript">
					...
					button     : "Image1"
						...
						<tr>
						  <td>Fecha de fin</td>
						  <td><input id="fechafin" type="text" class="cajaPequena" NAME="fechafin" maxlength="10" value="<? echo $fechafin?>"><img src="../img/calendario.png" name="Image2" id="Image2" width="16" height="16" border="0" title="Calendario2">
	   ...
	   <script type="text/javascript">
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
				...
				<div id="cabeceraResultado" class="header">
					RELACI&Oacute;N DE MOVIMIENTOS </div>
				<div id="frmResultado">
				...
				<div id="lineaResultadoLB" style=" width:100%">
