...
<html>
	...
	<body onload=inicio()>	
		<div id="pagina">
			<div id="zonaContenidoPImpuestos">
			<div align="center">
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="3%"><div align="center"><? echo mysql_result($res_resultado,$contador,"codimpuesto")?></div></td>
							<td width="5%"><div align="left"><? echo mysql_result($res_resultado,$contador,"nombre")?></div></td>
							<td width="5%"><div align="center"><? echo mysql_result($res_resultado,$contador,"valor")?></div></td>
							<td width="1%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_impuesto(<?php echo mysql_result($res_resultado,$contador,"codimpuesto")?>)" title="Modificar"></a></div></td>
														<td width="1%"><div align="center"><a href="#"><img src="../img/ver.png" width="16" height="16" border="0" onClick="ver_impuesto(<?php echo mysql_result($res_resultado,$contador,"codimpuesto")?>)" title="Visualizar"></a></div></td>
							<td width="1%"><div align="center"><a href="#"><img src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_impuesto(<?php echo mysql_result($res_resultado,$contador,"codimpuesto")?>)" title="Eliminar"></a></div></td>
						</tr>
						<? $contador++;
							}
						?>			
