...
<html>
	...
	<body onload=inicio()>	
		<div id="pagina">
			<div id="zonaContenidoPUbicaciones">
			<div align="center">
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="20%"><div align="center"><? echo mysql_result($res_resultado,$contador,"codubicacion")?></div></td>
							<td width="50%"><div align="center"><? echo mysql_result($res_resultado,$contador,"nombre")?></div></td>
							<td width="6%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_ubicacion(<?php echo mysql_result($res_resultado,$contador,"codubicacion")?>)" title="Modificar"></a></div></td>
														<td width="6%"><div align="center"><a href="#"><img src="../img/ver.png" width="16" height="16" border="0" onClick="ver_ubicacion(<?php echo mysql_result($res_resultado,$contador,"codubicacion")?>)" title="Visualizar"></a></div></td>
							<td width="6%"><div align="center"><a href="#"><img src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_ubicacion(<?php echo mysql_result($res_resultado,$contador,"codubicacion")?>)" title="Eliminar"></a></div></td>
						</tr>
						<? $contador++;
							}
						?>			
