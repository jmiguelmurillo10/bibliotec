...
<table width="50%" border="0">
  ...
  <tr>
    <td><span class="Estilo3"><? echo $nomempresa ?></span></td>
  </tr>
  <tr>
    <td><span class="Estilo3"><? echo $giro ?></span></td>
  </tr>
  <tr>
    <td><span class="Estilo3">Tel.: <? echo $fonos ?></span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><span class="Estilo3">DEL TICKET No.: <? echo $minimo?> AL TICKET No.: <? echo $maximo?></span></td>
  </tr>
  <tr>
    <td><span class="Estilo3">NETO: <? echo number_format($neto,2,".",",")?> + <? echo $ivaimp ?> % IVA: <? echo number_format($iva,2,".",",")?></span></td>
  </tr>
  <tr>
    <td><span class="Estilo3">TOTAL: <? echo number_format($total,2,".",",")?> <? echo $nombremoneda ?></span></td>
  </tr>
  ...
  <?php
		if (mysql_num_rows($rs_cobros) <= 0) {
			...
			while ($contador < mysql_num_rows($rs_cobros)) { ?>
				<tr>
					<td width="50%"><span class="Estilo3">Total <? echo mysql_result($rs_cobros, $contador, "nombrefp"); ?></span></td>
					<td><span class="Estilo3"><? echo $simbolomoneda; ?></span></td>
					<td align="right"><span class="Estilo3"><? echo number_format(mysql_result($rs_cobros, $contador, "total_forma_pago"),2,".",","); ?></span></td>
				</tr>
			<? 
  ...
  ?>				                    
    <tr>
        ...
        <td><span class="Estilo3"><? echo $simbolomoneda ?></span></td>
        <td align="right"><span class="Estilo3"><strong><? echo number_format($total_cobros,2,".",","); ?></strong></span></td>
    </tr>  
  <tr>
    <td>===========================================</td>
  </tr>
