	...
	<body onLoad="inicio()">
		...
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
							<div id="tituloForm" class="header">AUTORES
							</div>
							<div id="frmBusqueda">
											...
											<img src="../img/botonnuevousuario.jpg" width="106" height="22" border="1" onClick="nuevo_registro()" onMouseOver="style.cursor=cursor">
												...
												<div id="lineaResultado">
													<table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
														<tr>
															<td width="50%" align="left"># Autores Econtrados <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly></td>
