...
<body>
    ...
    <div id="pagina">
            <div id="zonaContenido">
                <div align="center"> 
                     <div id="tituloForm" class="header" background-color="green">REGISTRAR USUARIOS </div>
...
<tr class="prompt">
    <td colspan="2"><!--Para registrar un Usuario, solo debes llenar los siguientes campos,
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" name="i_tipoUsuario" id="i_tipoUsuario" enabled value="2" /> Usuario normal &nbsp;&nbsp;&nbsp;
